package net.corda.oracle.service

import net.corda.core.contracts.Command
import net.corda.core.contracts.StateAndContract
import net.corda.core.identity.CordaX500Name
import net.corda.core.transactions.TransactionBuilder
import net.corda.oracle.mock.ExchangeRatesOracleMock
import net.corda.oracle.base.contract.EXCHANGE_RATE_PROGRAM_ID
...
class ExchangeRateServiceTests {
    ...
    private val dummyServices = MockServices(listOf("net.corda.oracle.base.contract"), oracleIdentity)
